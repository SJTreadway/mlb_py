...
class TestRetroToMlbamPitchers:
    """Tests for retro ID to MLBAM ID conversion for pitchers."""
    
    def test_valid_retro_id(self):
        """Test conversion of valid retro ID."""
        # Gerrit Cole retro ID
        result = retro_to_mlbam('coleg001')
        assert result == 543037
